# The idea is the following (similar to previous): go from the left to the right and
# 1) if we meet start of segment, put one on this place.
# 2) if we meet end, put zero on the place of start.
# 3) traverse array 2 times from both sides.
